...
const projects = [{
  ...
  description: 'A Python application supporting 100+ languages across text, speech, image and PDF translation with AI-powered automatic language detection.',
  features: [
    'Supports 100+ languages with automatic detection',
    'Integrated OCR with 92–95% accuracy on PDF/DOCX',
    'Text-to-speech & Microsoft Translator API integration',
    'Translation history & export to PDF/DOCX via GUI',
  ],
  ...
  description: 'An AI-driven SOC platform using Flask, React, and ML models for real-time bot detection and behavioral analytics.',
  features: [
    'ML-based bot detection with Random Forest, Isolation Forest & XGBoost',
    'Nmap-based attack monitoring & automated threat response',
    'Flask REST APIs for real-time ML inference',
    'Real-time dashboards with WebSockets integration',
    'Automated security workflows (session termination, alerts)',
  ],
  tech: ['Python', 'Flask', 'React', 'XGBoost', 'WebSockets', 'Nmap'],
